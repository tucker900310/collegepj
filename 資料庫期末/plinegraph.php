...
$januser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-01%'";
...
$febuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-02%'";
...
$maruser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-03%'";
...
$apruser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-04%'";
...
$mayuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-05%'";
...
$junuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-06%'";
...
$julyuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-07%'";
...
$auguser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-08%'";
...
$sepuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-09%'";
...
$octuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-10%'";
...
$novuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE  E.rid=R.rid AND `date` LIKE '$yeartime-11%'";
...
$decuser_sql = "SELECT `eMoney` FROM expenses AS E NATURAL JOIN record AS R  WHERE E.rid=R.rid AND `date` LIKE '$yeartime-12%'";
...
$janinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-01%'";
...
$febinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-02%'";
...
$febin=$febin+$janin-$jan;   
}

$marinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-03%'";
...
$marin=$marin+$febin-$feb;   
}

$aprinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-04%'";
...
$aprin=$aprin+$marin-$mar;
}

$mayinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-05%'";
...
$mayin=$mayin+$aprin-$apr;   
}

$juninuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-06%'";
...
$junin=$junin+$mayin-$may;   
}

$julyinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-07%'";
...
$julyin=$julyin+$junin-$jun;   
}

$auginuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-08%'";
...
$augin=$augin+$julyin-$july;   
}

$sepinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-09%'";
...
$sepin=$sepin+$augin-$aug;   
}

$octinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-10%'";
...
$octin=$octin+$sepin-$sep;   
}

$novinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE I.rid=R.rid AND `date` LIKE '$yeartime-11%'";
...
$novin=$novin+$octin-$oct;   
}

$decinuser_sql = "SELECT `iMoney` FROM income AS I NATURAL JOIN record AS R  WHERE  I.rid=R.rid AND `date` LIKE '$yeartime-12%'";
...
$datay1=array($jan,$feb,$mar,$apr,$may,$jun,$july,$aug,$sep,$oct,$nov,$dec);
$datay2=array($janin,$febin,$marin,$aprin,$mayin,$junin,$julyin,$augin,$sepin,$octin,$novin,$decin);
...
$p1->SetColor("#6bb3ff");
$p1->SetLegend('expencese');
$p1->mark->SetType(MARK_FILLEDCIRCLE,'',1.0);
$p1->mark->SetColor('#6bb3ff');
$p1->mark->SetFillColor('#6bb3ff');
$p1->SetCenter();

$p2->SetColor("#f78d35");
$p2->SetLegend('net income');
$p2->mark->SetType(MARK_CIRCLE,'',1.0);
$p2->mark->SetColor('#f78d35');
$p2->mark->SetFillColor('#f78d35');
...
$graph->img->SetMargin(70,10,50,100);
