...
$graph->yaxis->SetTickPositions(array(0,5000,15000,25000,35000,45000,55000,65000,75000,85000,95000,105000), array(1000,10000,20000,30000,40000,50000,60000,70000,80000,90000,10000));
$graph->SetBox(false);
